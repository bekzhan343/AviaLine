...
public enum ApiErrorMessage {
    ...
    BOOKING_NOT_FOUND_BY_PNR_AND_SURNAME_MESSAGE("Booking not found, please check the surname and pnr number"),
    ORDER_NOT_FOUND_MESSAGE("Order not found!"),
    PASSENGER_NOT_FOUND_MESSAGE("Passenger not found!"),
    PARENT_PASSENGER_ID_NULL_MESSAGE("Parent passenger id cannot be null!"),
    DOC_NOT_AVAILABLE_MESSAGE("Document not available!"),
